...
import ColorPalette, { colorFormat, ColorPaletteShades } from '../interfaces/ColorPaletteInterface';


const levels = [100, 200, 300, 400, 500, 600, 700, 800, 900];

export default function generateShades(starterPalette:ColorPalette):ColorPaletteShades{
